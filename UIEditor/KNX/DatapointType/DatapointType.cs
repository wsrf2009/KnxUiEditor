...
using UIEditor.KNX.DatapointType.Type24TimesChannelActivation;
using UIEditor.KNX.DatapointType.Type2NibbleSet;
using UIEditor.KNX.DatapointType.Type3ByteColourRGB;
using UIEditor.KNX.DatapointType.Type3x2ByteFloatValue;
using UIEditor.KNX.DatapointType.Type411ByteCombinedInformation;
using UIEditor.KNX.DatapointType.TypeB16;
using UIEditor.KNX.DatapointType.TypeB16ConfigurationDiagnostics;
using UIEditor.KNX.DatapointType.TypeB24;
using UIEditor.KNX.DatapointType.TypeB32;
using UIEditor.KNX.DatapointType.TypeB8;
using UIEditor.KNX.DatapointType.TypeB8ConfigurationDiagnostics;
using UIEditor.KNX.DatapointType.TypeDatapointTypeVersion;
using UIEditor.KNX.DatapointType.TypeDate;
using UIEditor.KNX.DatapointType.TypeDPTAccessData;
using UIEditor.KNX.DatapointType.TypeDPTAlarmInfo;
using UIEditor.KNX.DatapointType.TypeDPTDateTime;
using UIEditor.KNX.DatapointType.TypeDPTSceneControl;
using UIEditor.KNX.DatapointType.TypeDPTSceneInfo;
using UIEditor.KNX.DatapointType.TypeElectricalEnergy;
using UIEditor.KNX.DatapointType.TypeLanguageCodeISO6391;
using UIEditor.KNX.DatapointType.TypeMBusAddress;
using UIEditor.KNX.DatapointType.Types2OctetFloatValue;
using UIEditor.KNX.DatapointType.Types2OctetSignedValue;
using UIEditor.KNX.DatapointType.Types2OctetUnsignedValue;
using UIEditor.KNX.DatapointType.Types4OctetFloatValue;
using UIEditor.KNX.DatapointType.Types4OctetSignedValue;
using UIEditor.KNX.DatapointType.Types4OctetUnsignedValue;
using UIEditor.KNX.DatapointType.Types8BitUnsignedValue;
using UIEditor.KNX.DatapointType.TypesB1;
using UIEditor.KNX.DatapointType.TypesB1U3;
using UIEditor.KNX.DatapointType.TypesB2;
using UIEditor.KNX.DatapointType.TypeSceneNumber;
using UIEditor.KNX.DatapointType.TypesCharacterSet;
using UIEditor.KNX.DatapointType.TypesN2;
using UIEditor.KNX.DatapointType.TypesN8;
using UIEditor.KNX.DatapointType.TypesString;
using UIEditor.KNX.DatapointType.TypesV8;
using UIEditor.KNX.DatapointType.TypeTime;

namespace UIEditor.KNX.DatapointType
{
