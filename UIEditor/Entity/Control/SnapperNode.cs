...
{
    [Serializable]
    public class SnapperNode : ControlBaseNode
    {
        ...
        public SnapperNode()
        {
            ...
            Name = ImageKey = SelectedImageKey = MyConst.Controls.KnxSnapperType;
        }


        public SnapperNode(KNXSnapper knx)
            : base(knx)
        {
        ...
        protected SnapperNode(SerializationInfo info, StreamingContext context) : base(info, context) { }
        #endregion

        #region ToKnx

        public KNXSnapper ToKnx()
        {
            var knx = new KNXSnapper();
        ...
        public override void ChangePropValues(CellContext context)
        {
            ...
            switch (row)
            {
                ...
                case 19:
                    ...
                    break;
                default:
                    ShowSaveEntityMsg(MyConst.Controls.KnxSnapperType);
                    break;
                #endregion
            }
        }
        ...
        public override ViewNode Clon2()
        {
            ...
            stream.Position = 0;
            return formatter.Deserialize(stream) as SnapperNode;
        }
    }
}
