...
namespace UIEditor.Entity.Control
{
    ...
    ///  新增于2.7.4
    /// </summary>
    [TypeConverter(typeof(AirConditionNode.PropertyConverter))]
    [Serializable]
    public class AirConditionNode : ControlBaseNode
    {
        #region 属性
        ...
        #region 构造函数
        public AirConditionNode()
        {
            index++;

            this.Name = ImageKey = SelectedImageKey = MyConst.Controls.KnxAirConditionType;

            this.Text = UIResMang.GetString("TextAirCondition");
            this.Title = UIResMang.GetString("TextAirCondition") + index;
            SetText(this.Title);
        ...
        public AirConditionNode(KNXAirCondition knx, BackgroundWorker worker)
            : base(knx, worker)
        {
            this.Name = ImageKey = SelectedImageKey = MyConst.Controls.KnxAirConditionType;
            SetText(this.Title);
        ...
        public AirConditionNode(KNXAirCondition knx, BackgroundWorker worker, string DirSrcImg)
            : this(knx, worker)
        {
        ...
        {
            AirConditionNode node = base.Clone() as AirConditionNode;
        ...
        {
            AirConditionNode node = base.Copy() as AirConditionNode;
        ...
        {
            base.SetText(UIResMang.GetString("TextAirCondition"));
        }

        public override string GetText(string text)
        {
            return base.GetText(UIResMang.GetString("TextAirCondition"));
        }
        ...
        #region 转为KNX
        public KNXAirCondition ToKnx(BackgroundWorker worker)
        {
            var knx = new KNXAirCondition();
        ...
        public KNXAirCondition ExportTo(BackgroundWorker worker, string dir, Point RelPoint)
        {
            KNXAirCondition knx = this.ToKnx(worker);
