...
namespace UIEditor.Entity.Control
{
    ...
    ///  新增于2.7.4
    /// </summary>
    [TypeConverter(typeof(MediaButtonNode.PropertyConverter))]
    [Serializable]
    public class MediaButtonNode : ControlBaseNode
    {
        #region 属性
        ...
        #region 构造函数
        public MediaButtonNode()
        {
            index++;

            this.Name = ImageKey = SelectedImageKey = MyConst.Controls.KnxMediaButtonType;

            this.Text = UIResMang.GetString("TextMediaButton");
            this.Title = UIResMang.GetString("TextMediaButton") + index;
            SetText(this.Title);
        ...
        {
            MediaButtonNode node = base.Clone() as MediaButtonNode;
        ...
        {
            MediaButtonNode node = base.Copy() as MediaButtonNode;
        ...
        {
            base.SetText(UIResMang.GetString("TextMediaButton"));
        }

        public override string GetText(string text)
        {
            return base.GetText(UIResMang.GetString("TextMediaButton"));
        }
